...
class RsErrorAnnotatorTest : RsAnnotationTestBase() {
    ...
    //- module.rs
        ...
        <error descr="File not found for module `nonono` [E0583]">#[path=""] mod nonono;</error>

        mod inner {
            <error descr="File not found for module `bar` [E0583]">mod bar;</error>
        }
    ...
    //- main.rs
        mod bar;
    //- bar/mod.rs
        <error descr="File not found for module `foo` [E0583]">mod /*caret*/foo;</error>
    ...
    //- main.rs
        mod foo;
    //- foo.rs
        <error descr="File not found for module `bar` [E0583]">mod /*caret*/bar;</error>
    """)
